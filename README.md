...
Wait for some time until the setup script creates a site. After that, you can access `http://localhost:80` in your browser and the app's login screen should show up.
...
1. Run the following commands:
 ...
 1. Now, you can access the site at `http://lms.test:80`
